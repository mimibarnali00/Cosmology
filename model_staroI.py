...
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_Epsilon1.pdf')
plt.show()
...
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_Epsilon1_EoI.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_HubbleRadius_Physical.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_HubbleRadius_Comoving.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_Powerspectra.pdf')
plt.show()
...
plt.legend()
#plt.ylim([0,0.5])
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_Tensortoscalarratio.pdf')
plt.show()
...
plt.ylim([0.9,1])
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_staroI_Spectralindex.pdf')
plt.show()
...
np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/PowerspectrumstaroI.txt', np.array([k, Ps(k,finGr,finGi), Pt(k,finhr,finhi), Pt(k,finhr,finhi)/Ps(k,finGr,finGi), ns]).T, delimiter='\t', fmt="%s",header='k    Ps    Pt    r    ns')
