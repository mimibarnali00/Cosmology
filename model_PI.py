...
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Epsilon1.pdf')
plt.show()
...
N60ind = np.where(N == N60[-1])[0][0]
eps1_60 = epsilon1[N60ind:-1]
eps1 = []
for i in eps1_60:
	eps1.append(i)
	if i > 1:
...
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Epsilon1_EoI.pdf')
plt.show()
...
pr = np.log10(a)[tr]
extra = -24 #adding some value to alomst exactly match the Hubble radius during inflation to that of radiation for visualization purposes.
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_HubbleRadius_Physical.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_HubbleRadius_Comoving.pdf')
plt.show()
...
#finding ai (Kp exits H at Ne-90)
kp = 0.05 #Mpc^-1
Np = N[infl-1]-90 #=Nend-90
ex = []
for i in N:
	if i < Np:
		ex.append(i)
...
plt.subplots_adjust(left=0.15,
                    ...
                    wspace=0.4,
                    hspace=0.4)
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Scalarperturbation.pdf')
plt.show()
...
plt.subplots_adjust(left=0.15,
                    ...
                    wspace=0.4,
                    hspace=0.4)
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Tensorperturbation.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Powerspectra.pdf')
plt.show()
...
plt.xlabel("$k$ in $Mpc^{-1}$")
plt.ylabel("$\%$ error")
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Scalarpowerspectrumerror.pdf')
plt.show()
...
plt.xlabel("$k$ in $Mpc^{-1}$")
plt.ylabel("$\%$ error")
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Tensorpowerspectrumerror.pdf')
plt.show()
...
plt.legend()
#plt.ylim([0,0.5])
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Tensortoscalarratio.pdf')
plt.show()
...
#plt.ylim([0.9,1])
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_PI_Spectralindex.pdf')
plt.show()

#writing values in files (change the file destination accordingly)
np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/BackgroundPI.txt', np.array([N, phi[0:infl-1,0], epsilon1, V, Hinf, z, dz, phi[0:infl-1,1], epsilon2, eta]).T, delimiter='\t', fmt="%s",header='N    phi    eps1    V    H    z    zN    phiN    eps2    eta')

np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/PerturbedPI.txt', np.array([NiNe(kp)[6], Gr, Gi, dGr, dGi, hr, hi, dhr, dhi]).T, delimiter='\t', fmt="%s",header='N    realG    imgG    realGN    imgGN    realh    imgh    realhN    imghN')

np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/PowerspectrumPI.txt', np.array([k, Ps(k,finGr,finGi), Pt(k,finhr,finhi), Pt(k,finhr,finhi)/Ps(k,finGr,finGi), ns]).T, delimiter='\t', fmt="%s",header='k    Ps    Pt    r    ns')
