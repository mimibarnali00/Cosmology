...
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Epsilon1.pdf')
plt.show()
...
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Epsilon1_EoI.pdf')
plt.show()
...
pr = np.log10(a)[tr]
extra = 1.9 #adding some value to alomst exactly match the Hubble radius during inflation to that of radiation for visualization purposes.
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_HubbleRadius_Physical.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_HubbleRadius_Comoving.pdf')
plt.show()
...
plt.subplots_adjust(left=0.15,
                    ...
                    wspace=0.4,
                    hspace=0.4)
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Scalarperturbation.pdf')
plt.show()
...
plt.subplots_adjust(left=0.15,
                    ...
                    wspace=0.4,
                    hspace=0.4)
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Tensorperturbation.pdf')
plt.show()
...
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Powerspectra.pdf')
plt.show()

percenterrscalar = (np.abs(Ps(k,finGr,finGi)-pssr)/pssr)*100

plt.figure(figsize=(12,9))
plt.title("Relative error in scalar power spectra in percentage")
plt.plot(k,percenterrscalar)
plt.xscale('log')
plt.xlabel("$k/Mpc^{-1}$")
plt.ylabel("$\%$ error")
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Scalarpowerspectrumerror.pdf')
plt.show()

percenterrtensor = (np.abs(Pt(k,finhr,finhi)-ptsr)/ptsr)*100

plt.figure(figsize=(12,9))
plt.title("Relative error in tensor power spectra in percentage")
plt.plot(k,percenterrtensor)
plt.xscale('log')
plt.xlabel("$k/Mpc^{-1}$")
plt.ylabel("$\%$ error")
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Tensorpowerspectrumerror.pdf')
plt.show()
...
plt.legend()
#plt.ylim([0,0.5])
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Tensortoscalarratio.pdf')
plt.show()
...
plt.ylim([0.8,1.2])
plt.legend()
plt.savefig('/home/barnali/Documents/GitHub/Cosmology/plots/model_lphi4_Spectralindex.pdf')
plt.show()

#writing values in files (change the file destination accordingly)
np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/Backgroundlphi4.txt', np.array([N, phi[0:infl-1,0], epsilon1, V, Hinf, z, dz, phi[0:infl-1,1], epsilon2]).T, delimiter='\t', fmt="%s",header='N    phi    eps1    V    H    z    zN    phiN    eps2')

np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/Perturbedlphi4.txt', np.array([NiNe(kp)[6], Gr, Gi, dGr, dGi, hr, hi, dhr, dhi]).T, delimiter='\t', fmt="%s",header='N    realG    imgG    realGN    imgGN    realh    imgh    realhN    imghN')

np.savetxt('/home/barnali/Documents/GitHub/Cosmology/files/Powerspectrumlphi4.txt', np.array([k, Ps(k,finGr,finGi), Pt(k,finhr,finhi), Pt(k,finhr,finhi)/Ps(k,finGr,finGi), ns]).T, delimiter='\t', fmt="%s",header='k    Ps    Pt    r    ns')
